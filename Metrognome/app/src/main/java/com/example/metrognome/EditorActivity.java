...
public class EditorActivity extends AppCompatActivity implements MeasureEditorAlertDialog.DialogListener {
    ...
    private void init() {
        ...
        recyclerView.setAdapter(new BeatAdapter(this, rhythm, true));
